...
$SRV1CS1.Duration                   = 12*3600  # 12 hours - 19:00
...
$SRV1Collector1 = $SRV1CS.DataCollectors.CreateDataCollector(0)
...
try
{
    ...
    $SRV1CS1.DataCollectors.Add($SRV1Collector) 
...
$SRV1CS2.Duration                   = 12*3600  # 12 hours - 19:00
...
$SRV1Collector2 = $SRV1CS.DataCollectors.CreateDataCollector(0)
...
# Create a schedule - start tomorrow morning at 07:00
$StartDate = Get-Date -Day $((Get-Date).Day+1) -Hour 6 -Minute 0 -Second 0
